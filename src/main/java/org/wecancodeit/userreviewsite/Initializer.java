...
public class Initializer implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		reviewRepo.save(new Review("Riding a Roller Coaster", 5,
				"https://upload.wikimedia.org/wikipedia/commons/2/2f/Pony_Express%2C_Knott%27s_Berry_Farm.jpg",
				"madlaw10",
				...
				categoryOne, tagOne));
		reviewRepo.save(new Review("Going to a Music Festival", 2,
				"https://upload.wikimedia.org/wikipedia/commons/6/67/Future_Music_Festival_2013_%288541725920%29.jpg",
				"madlaw10",
				"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae cupiditate tempore deserunt odit"
						+ " provident dolore architecto eius et quia temporibus harum ratione quisquam excepturi totam repellat,"
						+ " consequuntur assumenda debitis velit!",
		...
		reviewRepo.save(new Review("Opening a Bank Account", 3,
				"https://upload.wikimedia.org/wikipedia/commons/9/9a/Pictures_Not_Yet_Available.svg", "madlaw10",
				"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae cupiditate tempore deserunt odit"
						+ " provident dolore architecto eius et quia temporibus harum ratione quisquam excepturi totam repellat,"
						+ " consequuntur assumenda debitis velit!",
				categoryTwo, tagTwo, tagThree));
		reviewRepo.save(new Review("Burying Your Gold", 5,
				"https://upload.wikimedia.org/wikipedia/commons/6/6f/Lupines_AnnadelStateParkCA.jpg", "madlaw10",
				"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Beatae cupiditate tempore deserunt odit"
						+ " provident dolore architecto eius et quia temporibus harum ratione quisquam excepturi totam repellat,"
						+ " consequuntur assumenda debitis velit!",
		...
		reviewRepo.save(
				new Review("Skydiving", 0, "https://www.skydivelongisland.com/images/article/Skydive-Tracking.jpg",
						"madlaw10", "AHHHHHHHHHHHHHHH", categoryFive, tagOne));
